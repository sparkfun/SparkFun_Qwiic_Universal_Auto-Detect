#ifndef SPARKFUN_QUAD_SENSOR_HEADER_CCS811_5B_H // <=== Update this with the new sensor type
#define SPARKFUN_QUAD_SENSOR_HEADER_CCS811_5B_H // <=== Update this with the new sensor type
...
#define CLASSTITLE SFE_QUAD_Sensor_CCS811_5B // <=== Update this with the new sensor type
...
#define SENSOR_I2C_ADDRESSES const uint8_t sensorI2cAddresses[] = {0x5B} // <=== Update this with the I2C addresses for this sensor
