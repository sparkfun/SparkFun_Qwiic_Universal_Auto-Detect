#ifndef SPARKFUN_QUAD_SENSOR_HEADER_AHT20_H // <=== Update this with the new sensor type
#define SPARKFUN_QUAD_SENSOR_HEADER_AHT20_H // <=== Update this with the new sensor type

#include "AHT20/SparkFun_Qwiic_Humidity_AHT20.h" // <=== Update this with the new sensor library header file
...
#define CLASSNAME AHT20 // <=== Update this with the new sensor type

#define CLASSTITLE SFE_QUAD_Sensor_AHT20 // <=== Update this with the new sensor type
...
#define SENSOR_I2C_ADDRESSES const uint8_t sensorI2cAddresses[] = {0x38} // <=== Update this with the I2C addresses for this sensor
