#ifndef SPARKFUN_QUAD_SENSOR_HEADER_ADS122C04_H // <=== Update this with the new sensor type
#define SPARKFUN_QUAD_SENSOR_HEADER_ADS122C04_H // <=== Update this with the new sensor type

#include "ADS122C04/SparkFun_ADS122C04_ADC_Arduino_Library.h" // <=== Update this with the new sensor library header file
...
#define CLASSNAME SFE_ADS122C04 // <=== Update this with the new sensor type

#define CLASSTITLE SFE_QUAD_Sensor_ADS122C04 // <=== Update this with the new sensor type
...
#define SENSOR_I2C_ADDRESSES const uint8_t sensorI2cAddresses[] = {0x45, 0x44, 0x41, 0x40} // <=== Update this with the I2C addresses for this sensor
...
public:
  ...
  const char *getSettingName(uint8_t setting)
  {
    ...
    {
    case 0:
      return ("Use 4-Wire Mode");
      break;
    case 1:
      return ("Use 3-Wire Mode");
      break;
    case 2:
      return ("Use 2-Wire Mode");
      break;
    case 3:
      return ("Use 4-Wire High Temperature Mode");
      break;
    case 4:
      return ("Use 3-Wire High Temperature Mode");
      break;
    case 5:
      return ("Use 2-Wire High Temperature Mode");
      break;
    default:
      return (NULL);
      break;
  ...
  bool setSetting(uint8_t setting, SFE_QUAD_Sensor_Every_Type_t *value)
  {
    ...
    {
    case 0:
      device->configureADCmode(ADS122C04_4WIRE_MODE);
      break;
    case 1:
      device->configureADCmode(ADS122C04_3WIRE_MODE);
      break;
    case 2:
      device->configureADCmode(ADS122C04_2WIRE_MODE);
      break;
    case 3:
      device->configureADCmode(ADS122C04_4WIRE_HI_TEMP);
      break;
    case 4:
      device->configureADCmode(ADS122C04_3WIRE_HI_TEMP);
      break;
    case 5:
      device->configureADCmode(ADS122C04_2WIRE_HI_TEMP);
      break;
    default:
      return (false);
      break;
  ...
  bool getConfigurationItem(uint8_t configItem, SFE_QUAD_Sensor_Every_Type_t *value)
  {
    ...
    {
    case 0:
      value->UINT8_T = device->getWireMode();
      break;
    default:
      return (false);
      break;
  ...
  bool setConfigurationItem(uint8_t configItem, SFE_QUAD_Sensor_Every_Type_t *value)
  {
    ...
    {
    case 0:
      device->configureADCmode(value->UINT8_T);
      break;
    default:
      return (false);
      break;
