#ifndef SPARKFUN_QUAD_SENSOR_HEADER_MS5637_H // <=== Update this with the new sensor type
#define SPARKFUN_QUAD_SENSOR_HEADER_MS5637_H // <=== Update this with the new sensor type

#include "MS5637/SparkFun_MS5637_Arduino_Library.h" // <=== Update this with the new sensor library header file
...
#define CLASSNAME MS5637 // <=== Update this with the new sensor type

#define CLASSTITLE SFE_QUAD_Sensor_MS5637 // <=== Update this with the new sensor type
...
#define SENSOR_I2C_ADDRESSES const uint8_t sensorI2cAddresses[] = {0x76} // <=== Update this with the I2C addresses for this sensor
