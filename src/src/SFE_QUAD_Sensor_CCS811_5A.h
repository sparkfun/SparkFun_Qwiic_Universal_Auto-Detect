#ifndef SPARKFUN_QUAD_SENSOR_HEADER_CCS811_5A_H // <=== Update this with the new sensor type
#define SPARKFUN_QUAD_SENSOR_HEADER_CCS811_5A_H // <=== Update this with the new sensor type

#include "CCS811/SparkFunCCS811.h" // <=== Update this with the new sensor library header file
...
#define CLASSNAME CCS811 // <=== Update this with the new sensor type

#define CLASSTITLE SFE_QUAD_Sensor_CCS811_5A // <=== Update this with the new sensor type
...
#define SENSOR_I2C_ADDRESSES const uint8_t sensorI2cAddresses[] = {0x5A} // <=== Update this with the I2C addresses for this sensor
...
public:
  ...
  // Return the specified sense reading. ===> Adapt this to match the sensor type <===
