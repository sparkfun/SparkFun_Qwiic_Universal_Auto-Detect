#ifndef SPARKFUN_QUAD_SENSOR_HEADER_BME280_H // <=== Update this with the new sensor type
#define SPARKFUN_QUAD_SENSOR_HEADER_BME280_H // <=== Update this with the new sensor type

#include "BME280/SparkFunBME280.h" // <=== Update this with the new sensor library header file
...
#define CLASSNAME BME280 // <=== Update this with the new sensor type

#define CLASSTITLE SFE_QUAD_Sensor_BME280 // <=== Update this with the new sensor type
...
public:
  ...
  bool getSenseReading(uint8_t sense, char *reading)
  {
    ...
    {
    case 0:
      OLS_sprintf.OLS_etoa((double)device->readFloatPressure(), reading); // Get the pressure
      return (true);
      break;
    case 1:
      ...
      break;
    case 2:
      OLS_sprintf.OLS_etoa((double)device->readFloatHumidity(), reading); // Get the humidity
      return (true);
      break;
    default:
      return (false);
